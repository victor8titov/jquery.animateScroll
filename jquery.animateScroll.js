...
(function( $ ){
    $.fn.animateScroll = function( userOptions ) {  
        // Options 
        var o = {
            offset          : 100,  // Смещение от верха и низа. Тогда анимация к объекту будет применена когда он будет уже в зоне видимости а не на границе.
            ...
            delta           : 100, // Величина дескритизации. Т.е величина шага между запусками события. (px)
